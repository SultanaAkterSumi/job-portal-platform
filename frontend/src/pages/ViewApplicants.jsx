      ...
      <div style={{ backgroundColor: "white", borderBottom: "1px solid #e5e7eb", padding: "24px 16px" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          <button
            ...
            style={{ fontSize: "13px", color: "#6b7280", background: "none", border: "none", cursor: "pointer", marginBottom: "6px" }}
          >
            ← Back to Dashboard
          </button>
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "32px 16px" }}>
        ...
        {applicants.length === 0 ? (
          <div style={{ backgroundColor: "white", borderRadius: "12px", border: "1px solid #e5e7eb", padding: "48px", textAlign: "center" }}>
            ...
            <h2 style={{ fontSize: "20px", fontWeight: "bold", color: "#111827", marginBottom: "8px" }}>No Applications Yet</h2>
            <p style={{ color: "#6b7280" }}>No one has applied for this job yet.</p>
          </div>
        ) : (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            {applicants.map((app) => (
              <div key={app._id} style={{ backgroundColor: "white", borderRadius: "12px", border: "1px solid #e5e7eb", padding: "24px" }}>

                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "16px", marginBottom: "16px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
                    <div style={{ width: "48px", height: "48px", borderRadius: "50%", backgroundColor: "#ccf0ee", color: "#14b8a6", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "bold", fontSize: "18px", flexShrink: 0 }}>
                  ...
                  {app.applicant?.skills?.length > 0 && (
                    <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
                      {app.applicant.skills.slice(0, 4).map((skill) => (
                        <span key={skill} style={{ backgroundColor: "#f3f4f6", color: "#374151", fontSize: "11px", padding: "3px 8px", borderRadius: "20px" }}>
                          {skill}
                        </span>
                      ))}
                    </div>
